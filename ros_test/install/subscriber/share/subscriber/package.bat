...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\subscriber\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\subscriber\hook\ament_prefix_path.bat"
