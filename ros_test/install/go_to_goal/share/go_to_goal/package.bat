...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\go_to_goal\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\go_to_goal\hook\ament_prefix_path.bat"
